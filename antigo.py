# Este é para comparação do mês anterior com o mês atual
...
# ler o arquivo Excel
df = pd.read_csv(r"C:\Users\pedro\Downloads\presença embaixadores do rei(2026) (mês anterior).csv", encoding = "utf-8", sep = ";", skiprows = 4) # O "r" faz o Python ignorar as barras invertidas do caminho do Windows
